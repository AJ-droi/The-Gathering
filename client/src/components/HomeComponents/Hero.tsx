  ...
  return (
    <div className=' h-[auto] '>
        <div className='flex justify-end  img-clip3'>
            <img src={heroBgd} alt="heroBgd"  className='h-[80vh] opacity-[0.2]'/>
        </div>
        <HeroModal style={`absolute top-[0%] w-[100%] h-[90vh]  flex items-center px-[5%]`}>
            <div className='lg:w-[80%] text-[#fff] lg:text-left'>
            <h3 className="text-[30px] lg:text-[70px]">
                ...
                <Button title={`Join The Community`} classes="bg-[#FF6E31] w-[70%] md:w-[50%] lg:w-[25%] text-[#fff] h-[4vh] my-[4%] lg:mt-[2%] mx-auto lg:mx-[0%] px-[6%] lg:px-[0%]" source={join}></Button>
            </div>
        </HeroModal>
