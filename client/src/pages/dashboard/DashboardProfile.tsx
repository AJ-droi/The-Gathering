...
import { getSinglePhotographer, singleUser, updatePhotoProfile, updateProfile } from "../../redux/actions";
          ...
          <div className="flex flex-col lg:grid grid-cols-2 justify-center pl-[3%] py-[2%] ">
            ...
            <div className="w-[100%] flex flex-col items-start my-[1%]">
              ...
              <input
                type={"text"}
                name={"brandName"}
                placeholder={photo?.brandName}
                value={photoData?.brandName}
                className={
                  "border border-[#FF6E31] rounded-xl w-[100%] lg:w-[90%] py-[2%] pl-[2%] mt-[-8%] md:mt-[-3%] xl:mt-[-3%]"
                }
                onChange={photoChange}
            ...
            <div className="w-[100%] flex flex-col items-start my-[1%]">
              ...
              <input
                type={"tel"}
                name={"phone"}
                placeholder={photo?.phone}
                value={photoData?.phone}
                className={
                  "border border-[#FF6E31] rounded-xl w-[100%] lg:w-[90%] py-[2%] pl-[2%] mt-[-8%] md:mt-[-3%] xl:mt-[-3%]"
                }
                onChange={photoChange}
